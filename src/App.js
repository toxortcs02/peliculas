...
<header className="ht-header">
	<div className="container">
		<nav className="navbar navbar-default navbar-custom">
				...
				<div className="collapse navbar-collapse flex-parent" id="bs-example-navbar-collapse-1">
					<ul className="nav navbar-nav flex-child-menu menu-left">
						...
						<li className="dropdown first">
							<a className="btn btn-default dropdown-toggle lv1" data-toggle="dropdown" data-hover="dropdown">
							celebr/ities <i className="fa fa-angle-down" aria-hidden="true"></i>
							</a>
							<ul className="dropdown-menu level1">
								<li><a href="celebr/itygrid01.html">celebr/ity grid 01</a></li>
								<li><a href="celebr/itygrid02.html">celebr/ity grid 02 </a></li>
								<li><a href="celebr/itylist.html">celebr/ity list</a></li>
								<li className="it-last"><a href="celebr/itysingle.html">celebr/ity single</a></li>
							</ul>
						</li>
						<li className="dropdown first">
							<a className="btn btn-default dropdown-toggle lv1" data-toggle="dropdown" data-hover="dropdown">
	    ...
	    <div className="top-search">
			...
			<input type="text" placeholder="Search for a movie, TV Show or celebr/ity that you are looking for"/>
	    </div>
	</div>
</header>
...
<div className="page-single movie_list">
	<div className="container">
      ...
      <Movie  title="oblivion (2012)" score="8.1" description="Earth's mightiest heroes must come together and learn to fight as a team if they are to stop the mischievous Loki and his alien army from enslaving humanity..."   />
				...
				<div className="movie-item-style-2">
					...
					<div className="mv-item-infor">
						...
						<p className="describe">As Steve Rogers struggles to embr/ace his role in the modern world, he teams up with a fellow Avenger and S.H.I.E.L.D agent, Black Widow, to battle a new threat...</p>
						<p className="run-time"> Run Time: 2h21’    .     <span>MMPA: PG-13 </span>    .     <span>Release: 1 May 2015</span></p>
				...
				<div className="movie-item-style-2">
					...
					<div className="mv-item-infor">
						...
						<p className="describe">Armed with a super-suit with the astonishing ability to shrink in scale but increase in strength, cat burglar Scott Lang must embr/ace his inner hero and help...</p>
						<p className="run-time"> Run Time: 2h21’    .     <span>MMPA: PG-13 </span>    .     <span>Release: 1 May 2015</span></p>
